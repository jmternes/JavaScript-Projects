...
function placeXOrO(squareNumber) {
    //This condition ensures a square that hasn't been selected already
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If active player equals 'X', the x.png is placed in HTML
            select.style.backgroundImage = 'url("images/red-x.png")';
        ...
        audio('./media/button-click-sound-effect.mp3');
...
//This function parses the selectedSquares array to search for win conds.
...
//This function makes our body element unclickable, temporarily
function disableClick() {
    //this makes the body unclickable.
    body.style.pointerEvents = 'none';
    //this makes body clickable again after 1s
...
function audio(audioURL) {
    //we create new audio object and pass the path as a parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    //this lines accesses our canvas element in HTML
...
function animateLineDrawing() {
    ...
    if (x1 <= x2 && y1 <= y2) {
        ...
        if (y < y2) { y+=10; }
        //this condition cancels our animation loop if we've reached enpoints.
